    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-10">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="/guarantee/{{ $guarantee->id }}/update" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="persen" id="" value="{{$guarantee->persen}}" class="form-control mb-3 text-white"  required>
                        </div>
                    </div>
