                ...
                <form action="/bebanbarang/save" method="post">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="start_toOrder" id="" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Finish to Order</label>
                            <input type="date" name="finish_toOrder" id="" class="form-control mb-3 text-white"  required>
                        </div>
                    </div>
